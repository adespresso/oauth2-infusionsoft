...
use AdEspresso\OAuth2\Client\Provider\Infusionsoft;
use AdEspresso\OAuth2\Client\Provider\InfusionsoftResourceOwner;
...
class InfusionsoftTest extends TestCase
{
    ...
    {
        $this->provider = new Infusionsoft([
    ...
    public function testGetAuthorizationUrl()
    {
        ...
        $this->assertEquals('signin.infusionsoft.com', $uri['host']);
        $this->assertEquals('/app/oauth/authorize', $uri['path']);
    }
    ...
    public function testGetBaseAccessTokenUrl()
    {
        ...
        $this->assertEquals('api.infusionsoft.com', $uri['host']);
    ...
    public function testGetResourceOwnerDetailsUrl()
    {
        ...
        $this->assertEquals('api.infusionsoft.com', $uri['host']);
        $this->assertEquals('/crm/rest/v1/oauth/connect/userinfo', $uri['path']);
    }
    ...
    public function testGetAccessToken()
    {
        ...
        $this->assertEquals(time() + 86400, $token->getExpires());
    ...
    public function testUserData()
    {
        ...
        /** @var InfusionsoftResourceOwner $user */
        $user = $this->provider->getResourceOwner($token);

        $this->assertEquals($accessTokenInfo, $user->toArray());
        $this->assertEquals($accessTokenInfo['email'], $user->getEmail());
        $this->assertEquals($accessTokenInfo['family_name'], $user->getFamilyName());
        $this->assertEquals($accessTokenInfo['given_name'], $user->getGivenName());
        $this->assertEquals($accessTokenInfo['global_user_id'], $user->getId());
        $this->assertEquals($accessTokenInfo['infusionsoft_id'], $user->getInfusionsoftId());
        $this->assertEquals($accessTokenInfo['middle_name'], $user->getMiddleName());
        $this->assertEquals($accessTokenInfo['preferred_name'], $user->getPreferredName());
        $this->assertEquals($accessTokenInfo['sub'], $user->getSub());
    }
